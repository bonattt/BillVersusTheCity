...
public class SpawnPrefabEffect : IAttackHitEffect,
        IAttackShootEffect, IAttackMissEffect, IMeleeAttackEffect
{
    ...
    public void DisplayMeleeEffect(Vector3 position, Vector3 attack_direction, IAttack attack)
    {
        GameObject obj = SpawnPrefab(position);
        Quaternion rotation = Quaternion.LookRotation(attack_direction, Vector3.up);
